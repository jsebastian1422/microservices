...
const patien_detail_model_1 = __importDefault(require("./patien_detail.model"));
...
Patient.hasOne(gender_model_1.default, {
    foreignKey: 'sexo_id',
    sourceKey: 'tipo_sexo_id',
});
Patient.hasOne(gender_identity_model_1.default, {
    foreignKey: 'identidad_genero_id',
    sourceKey: 'identidad_genero_id',
    allowNull: true
});
Patient.hasOne(ethnicity_model_1.default, {
    foreignKey: 'pert_etnica_id',
    sourceKey: 'pert_etnica_id',
    allowNull: true
});
Patient.hasOne(marital_status_model_1.default, {
    foreignKey: 'tipo_estado_civil_id',
    sourceKey: 'tipo_estado_civil_id',
    allowNull: true
});
Patient.hasOne(occupation_model_1.default, {
    foreignKey: 'ocupacion_id',
    sourceKey: 'ocupacion_id',
    allowNull: true
});
Patient.hasOne(patien_detail_model_1.default, {
